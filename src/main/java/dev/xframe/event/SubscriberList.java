 ...
 * @param <E>
 */
class SubscriberList<E> implements List<E>, RandomAccess {
    ...
    public SubscriberList(Collection<? extends E> c) {
        Object[] elements;
        if (c.getClass() == SubscriberList.class)
            elements = ((SubscriberList<?>)c).getArray();
        else {
            elements = c.toArray();
    ...
    public SubscriberList(E[] toCopyIn) {
    ...
    public synchronized boolean addAll(Collection<? extends E> c) {
        Object[] cs = (c.getClass() == SubscriberList.class) ?
                ((SubscriberList<?>)c).getArray() : c.toArray();
        if (cs.length == 0)
            return false;
        Object[] elements = getArray();
        int len = elements.length;
